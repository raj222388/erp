...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Greenfield Academy — A Modern School for Curious Minds" },
      { name: "description", content: "Greenfield Academy is a modern K–12 school focused on academic excellence, character, and community." },
      { property: "og:site_name", content: "Greenfield Academy" },
